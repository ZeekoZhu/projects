...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FieldCreateMetadata")]
    public partial class FieldCreateMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldCreateMetadata" /> class.
        /// </summary>
        ...
        public FieldCreateMetadata(FieldCreateMetadataSchema schema = default(FieldCreateMetadataSchema))
        {
            // to ensure "schema" is required (not null)
            if (schema == null)
            {
                throw new ArgumentNullException("schema is a required property for FieldCreateMetadata and cannot be null");
            }
            this.Schema = schema;
        }
