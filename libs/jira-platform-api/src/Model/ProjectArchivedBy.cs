...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Project_archivedBy")]
    public partial class ProjectArchivedBy : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectArchivedBy" /> class.
        /// </summary>
        ...
        public ProjectArchivedBy(string accountId = default(string), UserApplicationRoles applicationRoles = default(UserApplicationRoles), UserAvatarUrls avatarUrls = default(UserAvatarUrls), UserGroups groups = default(UserGroups), string key = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectArchivedBy {\n");
