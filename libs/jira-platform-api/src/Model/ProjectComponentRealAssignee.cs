...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectComponent_realAssignee")]
    public partial class ProjectComponentRealAssignee : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectComponentRealAssignee" /> class.
        /// </summary>
        ...
        public ProjectComponentRealAssignee(string accountId = default(string), UserApplicationRoles applicationRoles = default(UserApplicationRoles), UserAvatarUrls avatarUrls = default(UserAvatarUrls), UserGroups groups = default(UserGroups), string key = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectComponentRealAssignee {\n");
