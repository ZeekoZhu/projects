...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_applicationRoles")]
    public partial class UserApplicationRoles : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserApplicationRoles" /> class.
        /// </summary>
        ...
        public UserApplicationRoles(Object callback = default(Object), List<ApplicationRole> items = default(List<ApplicationRole>), int maxResults = default(int), Object pagingCallback = default(Object), int size = default(int))
        {
