...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimpleErrorCollection")]
    public partial class SimpleErrorCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleErrorCollection" /> class.
        /// </summary>
        ...
        public SimpleErrorCollection(List<string> errorMessages = default(List<string>), Dictionary<string, string> errors = default(Dictionary<string, string>), int httpStatusCode = default(int))
        {
