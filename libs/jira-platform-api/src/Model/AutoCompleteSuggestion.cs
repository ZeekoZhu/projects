...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AutoCompleteSuggestion")]
    public partial class AutoCompleteSuggestion : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoCompleteSuggestion" /> class.
        /// </summary>
        /// <param name="displayName">The display name of a suggested item. If &#x60;fieldValue&#x60; or &#x60;predicateValue&#x60; are provided, the matching text is highlighted with the HTML bold tag..</param>
        /// <param name="value">The value of a suggested item..</param>
        public AutoCompleteSuggestion(string displayName = default(string), string value = default(string))
        {
