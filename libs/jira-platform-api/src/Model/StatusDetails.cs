...
namespace Projects.JiraPlatformApi.Model
{
    ...
    public partial class StatusDetails : IValidatableObject
    {
        /// <summary>
        ...
        public StatusDetails(StatusDetailsScope scope = default(StatusDetailsScope), StatusDetailsStatusCategory statusCategory = default(StatusDetailsStatusCategory))
        {
            this.Scope = scope;
