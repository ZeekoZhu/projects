...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateNotificationSchemeDetails")]
    public partial class CreateNotificationSchemeDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNotificationSchemeDetails" /> class.
        /// </summary>
        ...
        /// <param name="name">The name of the notification scheme. Must be unique (case-insensitive). (required).</param>
        /// <param name="notificationSchemeEvents">The list of notifications which should be added to the notification scheme..</param>
        public CreateNotificationSchemeDetails(string description = default(string), string name = default(string), List<NotificationSchemeEventDetails> notificationSchemeEvents = default(List<NotificationSchemeEventDetails>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateNotificationSchemeDetails and cannot be null");
            }
            this.Name = name;
