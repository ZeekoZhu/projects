...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Project_avatarUrls")]
    public partial class ProjectAvatarUrls : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectAvatarUrls" /> class.
        /// </summary>
        ...
        public ProjectAvatarUrls(string var16x16 = default(string), string var24x24 = default(string), string var32x32 = default(string), string var48x48 = default(string))
        {
