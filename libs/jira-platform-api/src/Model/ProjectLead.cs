...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Project_lead")]
    public partial class ProjectLead : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectLead" /> class.
        /// </summary>
        ...
        public ProjectLead(string accountId = default(string), UserApplicationRoles applicationRoles = default(UserApplicationRoles), UserAvatarUrls avatarUrls = default(UserAvatarUrls), UserGroups groups = default(UserGroups), string key = default(string), string name = default(string))
        {
