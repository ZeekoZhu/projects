...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// AvatarUrlsBean
    /// </summary>
    [DataContract(Name = "AvatarUrlsBean")]
    public partial class AvatarUrlsBean : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvatarUrlsBean" /> class.
        /// </summary>
        ...
        public AvatarUrlsBean(string var16x16 = default(string), string var24x24 = default(string), string var32x32 = default(string), string var48x48 = default(string))
        {
