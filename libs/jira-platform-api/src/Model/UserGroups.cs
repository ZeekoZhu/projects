...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_groups")]
    public partial class UserGroups : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroups" /> class.
        /// </summary>
        ...
        public UserGroups(Object callback = default(Object), List<GroupName> items = default(List<GroupName>), int maxResults = default(int), Object pagingCallback = default(Object), int size = default(int))
        {
