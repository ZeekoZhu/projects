...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimpleListWrapperApplicationRole")]
    public partial class SimpleListWrapperApplicationRole : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleListWrapperApplicationRole" /> class.
        /// </summary>
        ...
        public SimpleListWrapperApplicationRole(Object callback = default(Object), List<ApplicationRole> items = default(List<ApplicationRole>), int maxResults = default(int), Object pagingCallback = default(Object), int size = default(int))
        {
