...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IssueTransition_to")]
    public partial class IssueTransitionTo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueTransitionTo" /> class.
        /// </summary>
        /// <param name="scope">scope.</param>
        /// <param name="statusCategory">statusCategory.</param>
        public IssueTransitionTo(StatusDetailsScope scope = default(StatusDetailsScope), StatusDetailsStatusCategory statusCategory = default(StatusDetailsStatusCategory))
        {
            this.Scope = scope;
        ...
        public StatusDetailsScope Scope { get; set; }
