...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Fields_status")]
    public partial class FieldsStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldsStatus" /> class.
        /// </summary>
        /// <param name="scope">scope.</param>
        /// <param name="statusCategory">statusCategory.</param>
        public FieldsStatus(StatusDetailsScope scope = default(StatusDetailsScope), StatusDetailsStatusCategory statusCategory = default(StatusDetailsStatusCategory))
        {
            this.Scope = scope;
