...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// GlobalScopeBean
    /// </summary>
    [DataContract(Name = "GlobalScopeBean")]
    public partial class GlobalScopeBean : IValidatableObject
    {
        /// <summary>
        /// Defines Attributes
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalScopeBean" /> class.
        /// </summary>
        /// <param name="attributes">Defines the behavior of the option in the global context.If notSelectable is set, the option cannot be set as the field&#39;s value. This is useful for archiving an option that has previously been selected but shouldn&#39;t be used anymore.If defaultValue is set, the option is selected by default..</param>
        public GlobalScopeBean(List<AttributesEnum> attributes = default(List<AttributesEnum>))
        {
