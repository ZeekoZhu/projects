...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Dashboard_owner")]
    public partial class DashboardOwner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardOwner" /> class.
        /// </summary>
        ...
        public DashboardOwner(string accountId = default(string), bool active = default(bool), UserBeanAvatarUrls avatarUrls = default(UserBeanAvatarUrls), string displayName = default(string), string key = default(string), string name = default(string), string self = default(string))
        {
