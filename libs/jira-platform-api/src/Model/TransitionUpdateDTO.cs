...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitionUpdateDTO")]
    public partial class TransitionUpdateDTO : IValidatableObject
    {
        /// <summary>
        /// The transition type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitionUpdateDTO" /> class.
        /// </summary>
        ...
        /// <param name="type">The transition type. (required).</param>
        /// <param name="validators">The validators of the transition..</param>
        public TransitionUpdateDTO(List<WorkflowRuleConfiguration> actions = default(List<WorkflowRuleConfiguration>), ConditionGroupUpdate conditions = default(ConditionGroupUpdate), string customIssueEventId = default(string), string description = default(string), List<StatusReferenceAndPort> from = default(List<StatusReferenceAndPort>), string id = default(string), string name = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), StatusReferenceAndPort to = default(StatusReferenceAndPort), WorkflowRuleConfiguration transitionScreen = default(WorkflowRuleConfiguration), List<WorkflowTrigger> triggers = default(List<WorkflowTrigger>), TypeEnum type = default(TypeEnum), List<WorkflowRuleConfiguration> validators = default(List<WorkflowRuleConfiguration>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TransitionUpdateDTO and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TransitionUpdateDTO and cannot be null");
            }
            this.Name = name;
            this.Type = type;
        ...
        [DataMember(Name = "customIssueEventId", EmitDefaultValue = false)]
