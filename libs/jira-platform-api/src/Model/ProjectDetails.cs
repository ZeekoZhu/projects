...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectDetails")]
    public partial class ProjectDetails : IValidatableObject
    {
        ...
        public ProjectDetails(ProjectAvatarUrls avatarUrls = default(ProjectAvatarUrls), string id = default(string), ProjectDetailsProjectCategory projectCategory = default(ProjectDetailsProjectCategory))
        {
