...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkflowScheme_lastModifiedUser")]
    public partial class WorkflowSchemeLastModifiedUser : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowSchemeLastModifiedUser" /> class.
        /// </summary>
        ...
        public WorkflowSchemeLastModifiedUser(string accountId = default(string), UserApplicationRoles applicationRoles = default(UserApplicationRoles), UserAvatarUrls avatarUrls = default(UserAvatarUrls), UserGroups groups = default(UserGroups), string key = default(string), string name = default(string))
        {
