...
namespace Projects.JiraPlatformApi.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        public User(string accountId = default(string), UserApplicationRoles applicationRoles = default(UserApplicationRoles), UserAvatarUrls avatarUrls = default(UserAvatarUrls), UserGroups groups = default(UserGroups), string key = default(string), string name = default(string))
        {
