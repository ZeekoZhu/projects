...
namespace Projects.JiraPlatformApi.Model
{
    ...
    public partial class Resource : IValidatableObject
    {
        ...
        public Resource(string description = default(string), System.IO.Stream file = default(System.IO.Stream), string filename = default(string), Object inputStream = default(Object), bool open = default(bool), bool readable = default(bool), string uri = default(string), string url = default(string))
        {
