...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimeTrackingConfiguration")]
    public partial class TimeTrackingConfiguration : IValidatableObject
    {
        /// <summary>
        ...
        public TimeTrackingConfiguration(DefaultUnitEnum defaultUnit = default(DefaultUnitEnum), TimeFormatEnum timeFormat = default(TimeFormatEnum), double workingDaysPerWeek = default(double), double workingHoursPerDay = default(double))
        {
