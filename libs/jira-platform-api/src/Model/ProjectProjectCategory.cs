...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Project_projectCategory")]
    public partial class ProjectProjectCategory : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectProjectCategory" /> class.
        /// </summary>
        ...
        public ProjectProjectCategory(string description = default(string), string name = default(string))
        {
