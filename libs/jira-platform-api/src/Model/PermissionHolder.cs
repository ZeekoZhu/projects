...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PermissionHolder")]
    public partial class PermissionHolder : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionHolder" /> class.
        /// </summary>
        ...
        public PermissionHolder(string varParameter = default(string), string type = default(string), string value = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for PermissionHolder and cannot be null");
            }
            this.Type = type;
