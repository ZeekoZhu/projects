...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectIssueCreateMetadata_avatarUrls")]
    public partial class ProjectIssueCreateMetadataAvatarUrls : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectIssueCreateMetadataAvatarUrls" /> class.
        /// </summary>
        ...
        public ProjectIssueCreateMetadataAvatarUrls(string var16x16 = default(string), string var24x24 = default(string), string var32x32 = default(string), string var48x48 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectIssueCreateMetadataAvatarUrls {\n");
