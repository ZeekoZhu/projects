...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectRole")]
    public partial class ProjectRole : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectRole" /> class.
        /// </summary>
        /// <param name="currentUserRole">Whether the calling user is part of this role..</param>
        ...
        public ProjectRole(bool currentUserRole = default(bool), string name = default(string), ProjectRoleScope scope = default(ProjectRoleScope), string translatedName = default(string))
        {
        ...
        /// <summary>
        /// Returns false as Actors should not be serialized given that it's read-only.
        /// </summary>
