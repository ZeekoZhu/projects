...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskProgressBeanRemoveOptionFromIssuesResult")]
    public partial class TaskProgressBeanRemoveOptionFromIssuesResult : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskProgressBeanRemoveOptionFromIssuesResult" /> class.
        /// </summary>
        ...
        public TaskProgressBeanRemoveOptionFromIssuesResult(string description = default(string), long elapsedRuntime = default(long), long finished = default(long), string id = default(string), long lastUpdate = default(long), string message = default(string), long progress = default(long), RemoveOptionFromIssuesResult result = default(RemoveOptionFromIssuesResult), string self = default(string), long started = default(long), StatusEnum status = default(StatusEnum), long submitted = default(long), long submittedBy = default(long))
        {
            this.ElapsedRuntime = elapsedRuntime;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TaskProgressBeanRemoveOptionFromIssuesResult and cannot be null");
            }
            this.Id = id;
            ...
            if (self == null)
            {
                throw new ArgumentNullException("self is a required property for TaskProgressBeanRemoveOptionFromIssuesResult and cannot be null");
            }
            this.Self = self;
            this.Status = status;
