...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Worklog_updateAuthor")]
    public partial class WorklogUpdateAuthor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorklogUpdateAuthor" /> class.
        /// </summary>
        ...
        public WorklogUpdateAuthor(string accountId = default(string), UserAvatarUrls avatarUrls = default(UserAvatarUrls))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorklogUpdateAuthor {\n");
