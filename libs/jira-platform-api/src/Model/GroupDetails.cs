...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupDetails")]
    public partial class GroupDetails : IValidatableObject
    {
        /// <summary>
        ...
        public GroupDetails(string groupId = default(string), string name = default(string))
        {
