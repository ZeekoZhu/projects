...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Fields_issueType")]
    public partial class FieldsIssueType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldsIssueType" /> class.
        /// </summary>
        /// <param name="scope">scope.</param>
        public FieldsIssueType(IssueTypeDetailsScope scope = default(IssueTypeDetailsScope))
        {
            this.Scope = scope;
        }
