...
namespace Projects.JiraPlatformApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatePriorityDetails")]
    public partial class UpdatePriorityDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePriorityDetails" /> class.
        /// </summary>
        ...
        /// <param name="name">The name of the priority. Must be unique..</param>
        /// <param name="statusColor">The status color of the priority in 3-digit or 6-digit hexadecimal format..</param>
        public UpdatePriorityDetails(string description = default(string), IconUrlEnum? iconUrl = default(IconUrlEnum?), string name = default(string), string statusColor = default(string))
        {
